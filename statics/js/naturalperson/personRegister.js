   $(function(){
	   document.getElementById("personTwoDIV").style.display="none"; 
	   createCode();
	 //用户协议弹窗
...
var passwordTests=false;
   ...
   //下一步数据确认
	...
	var t=	$("#agreecheck").prop("checked");
        ...
        document.getElementById("personTwoDIV").style.display="block";
	...
	//开始注册
	  $.ajax({ 
		  url:jsCtx+"/natural/personRegisterSubmit.do",
	                type:"post",
	                data:{"userName":userName2,"loginNo":userNameResult,"loginPwd":encrypt(passwordResult),"certNo":certNo,"userMobile":phoneResult,"startTime":startTime,"endTime":endTime,"certType":certType,"UUID":UUID},
	                dataType:"json",
